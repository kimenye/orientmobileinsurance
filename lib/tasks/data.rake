namespace :data do
  ...
  task :seed => :environment do
    ...
    insured_device = InsuredDevice.create! :customer_id => customer.id, :device_id => Device.find_by_stock_code("BB9300").id, :imei => "123456789012345", :yop => 2013, :phone_number => "254705866564"
